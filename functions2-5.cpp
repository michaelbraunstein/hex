			...
			cout << "to convert hexadecimal to decimal" << "\n " << endl;
				...
				if (conv == 1) {
					...
					for (int i = myhex.length() - 1; i = 0; i--) {
						    if  (myhex[i] == '0') dec += 0 * (1 <<(4 * pwr));
						else if (myhex[i] == '1') dec += 1 * (1 << (4 * pwr));
						else if (myhex[i] == '2') dec += 2 * (1 << (4 * pwr));
						else if (myhex[i] == '3') dec += 3 * (1 << (4 * pwr));
						else if (myhex[i] == '4') dec += 4 * (1 << (4 * pwr));
						else if (myhex[i] == '5') dec += 5 * (1 << (4 * pwr));
						else if (myhex[i] == '6') dec += 6 * (1 << (4 * pwr));
						else if (myhex[i] == '7') dec += 7 * (1 << (4 * pwr));
						else if (myhex[i] == '8') dec += 8 * (1 << (4 * pwr));
						else if (myhex[i] == '9') dec += 9 * (1 << (4 * pwr));
						else if (myhex[i] == 'A') dec += 10 * (1 << (4 * pwr));
						else if (myhex[i] == 'B') dec += 11 * (1 << (4 * pwr));
						else if (myhex[i] == 'C') dec += 12 * (1 << (4 * pwr));
						else if (myhex[i] == 'D') dec += 13 * (1 << (4 * pwr));
						else if (myhex[i] == 'E') dec += 14 * (1 << (4 * pwr));
						else if (myhex[i] == 'F') dec += 15 * (1 << (4 * pwr));
						pwr++;
					}
